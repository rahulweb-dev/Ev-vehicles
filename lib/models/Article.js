...
// Covers category-filtered news page queries with their publishedAt sort — avoids in-memory sort
...
// Scheduler query: find articles where scheduledAt <= now and status = draft
ArticleSchema.index({ scheduledAt: 1, status: 1 });
// Removed content from text index — full article HTML bloats the index enormously and slows writes
