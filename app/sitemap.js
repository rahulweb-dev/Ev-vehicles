...
const STATIC_PAGES = [
  ...
  { url: `${SITE_URL}/upcoming-electric-bikes-india`,  priority: 0.9,  freq: "weekly"  },
  { url: `${SITE_URL}/electric-cars-under-10-lakh`,    priority: 0.9,  freq: "weekly"  },
  { url: `${SITE_URL}/electric-bikes-under-1-lakh`,    priority: 0.9,  freq: "weekly"  },
  { url: `${SITE_URL}/electric-bikes-under-50000`,     priority: 0.88, freq: "weekly"  },
