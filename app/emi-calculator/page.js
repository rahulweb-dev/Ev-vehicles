...
// Metadata can't be exported from client components — use a separate layout or head tag approach
// This page uses a separate metadata export via a server wrapper; SEO handled in head
...
export default function EMICalculatorPage() {
  ...
  return (
    <>
      <head>
        <title>EV EMI Calculator India 2026 – Electric Vehicle Loan Calculator | EV News India</title>
        <meta name="description" content="Calculate your electric vehicle EMI instantly. Enter EV price, down payment, loan tenure and interest rate to get monthly EMI, total interest and amortization schedule. Free EV loan calculator India." />
        <link rel="canonical" href={`${SITE_URL}/emi-calculator`} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "EV EMI Calculator India",
          "description": "Free electric vehicle EMI calculator for India. Calculate monthly EMI, total interest and loan amortization for EV purchase.",
      ...
      <main className="min-h-screen bg-gray-50 pb-16">
        ...
        <div className="mx-auto max-w-5xl px-4 py-10">
                  ...
                  {[
                    ...
                    <div key={row.label} className="flex items-center justify-between rounded-xl bg-gray-50 px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-xl ${row.color}`}>
                          <row.icon size={14} />
                        </div>
          ...
          <section className="mt-10 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            {[
              {
                q: "What is the typical interest rate for an EV loan in India?",
                a: "EV loan interest rates in India range from 7.5% to 12% per annum in 2026. Banks like SBI, HDFC, and ICICI offer preferential rates for EVs. Some state governments offer an additional 2–3% interest subsidy under their EV policies. Union Bank of India's 'Green Car Loan' offers rates starting at 7.5% for EVs."
              },
              {
                q: "How much down payment is required for an EV loan?",
                a: "Most banks require a minimum down payment of 15–20% of the vehicle's ex-showroom price for EV loans. A higher down payment reduces your EMI and total interest paid. Under FAME-II and state subsidy schemes, the effective on-road price may be lower, reducing the loan amount needed."
              },
              {
                q: "What is the maximum tenure for an EV car loan?",
                a: "EV car loans in India are typically available for tenures up to 7 years (84 months). For two-wheelers and e-bikes, the maximum tenure is usually 3–5 years. Longer tenure means lower EMI but higher total interest outflow."
              },
              {
                q: "Are there any tax benefits on EV loans in India?",
                a: "Yes. Under Section 80EEB of the Income Tax Act, you can claim a deduction of up to ₹1.5 lakh per year on the interest paid on an EV loan. This benefit is available to individual taxpayers (not companies) who purchase EVs for personal use. The loan must be from a bank or NBFC registered in India."
              },
            ].map((faq, i) => (
