...
export default function NewsArticleError({ error, reset }) {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center">
      <h1 className="text-3xl font-black text-gray-900 dark:text-white mb-3">Article Unavailable</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md">
        This article couldn&apos;t be loaded right now. It may have been moved or temporarily unavailable.
      </p>
